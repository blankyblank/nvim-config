...
vim.keymap.set("n", '<leader>cr', "<cmd>lua Snacks.picker.lsp_references({ include_current = true, auto_confirm = false })<CR>", { nowait = true, desc = "References" })
...
vim.keymap.set("n", '<leader>csr', ":lua vim.lsp.buf.references() <CR>", { desc = 'show references to symbol' })
